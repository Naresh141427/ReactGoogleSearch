...
class AppStore extends Component {
  ...
  getFilteredAppList = () => {
    ...
    if (searchInput) {
      const filterOnTabId = appsList.filter(
        eachTab => eachTab.category === activeId,
      )
      const filterOnAppName = filterOnTabId.filter(eachApp =>
